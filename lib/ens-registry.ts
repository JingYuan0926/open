...
// ────────────────────────────────────────────────────────────────────────────
// Server-side registrar (private-key signer)
// ────────────────────────────────────────────────────────────────────────────
...
export type RegisterSpecialistInput = {
    label: string;
    records: SpecialistRecords;
    owner?: Address;        // defaults to the registrar wallet
...
export async function registerSpecialist(
    ...
    // Records can only be set by the subname owner. When `owner` is overridden
    // to a different address, that wallet must call multicall itself.
    ...
    const calls = encodeTextRecordCalls(subdomainNode, input.records);
...
// ────────────────────────────────────────────────────────────────────────────
// Read path (works with or without a private key)
// ────────────────────────────────────────────────────────────────────────────
